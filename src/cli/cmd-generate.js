...
var cmdGenerate = function () { return __awaiter(void 0, void 0, void 0, function () {
    var cmd, settings, schema;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                cmd = commands_js_1.COMMANDS.generate;
            ...
            case 3:
                _a.sent();
                prompts_1.log.message("Schema saved to ".concat((0, utils_js_1.formatFilePath)(settings.currentSchemaFullPath), "."));
