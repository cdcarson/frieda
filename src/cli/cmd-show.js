...
var cmdShow = function (restArgs) { return __awaiter(void 0, void 0, void 0, function () {
    var cmd, settings, conn, schema;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                cmd = commands_js_1.COMMANDS.show;
            ...
            case 1:
                settings = _a.sent();
                conn = (0, utils_js_1.getServerlessConnection)(settings.databaseUrl);
                return [4 /*yield*/, (0, schema_js_1.fetchSchema)(conn)];
            case 2:
                schema = _a.sent();
                return [4 /*yield*/, fs_extra_1.default.writeJSON((0, path_1.join)(settings.schemaDirectory, 'schema.json'), schema, { spaces: 1 })];
            case 3:
                _a.sent();
