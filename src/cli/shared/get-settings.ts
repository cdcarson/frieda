...
import type { RcSettings, ResolvedFriedaVars } from './types.js';
...
// export const getSettings = async (forcePrompts = false): Promise<ResolvedFriedaVars> => {
//   const originalRcVars = await readFriedaRcVars();
//   const externalTypeImports: string[] = originalRcVars.externalTypeImports || []
//   let { schemaDirectory: migrationsDirectory, generatedCodeDirectory: generatedModelsDirectory } =
//     originalRcVars;
...
//       const rcVarsToSave: RcSettings = {
//         generatedCodeDirectory: relative(
//           process.cwd(),
//           generatedModelsDirectoryFullPath
//         ),
//         schemaDirectory: relative(
//           process.cwd(),
...
// };
// const readFriedaRcVars = async (): Promise<RcSettings> => {
...
//   }
//   try {
//     return (await fs.readJson(rcPath)) as RcSettings;
//   } catch (error) {
//     return {};
//   }
// };
