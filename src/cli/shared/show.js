...
var promptModel = function (models, nameFilter) {
    if (nameFilter === void 0) { nameFilter = null; }
    return __awaiter(void 0, void 0, void 0, function () {
        var modelsToShow, options, value;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    options = modelsToShow.length > 0
                        ? modelsToShow.map(function (m) {
                    ...
                    if (modelsToShow.length > 0 && nameFilter) {
                        options.push({
                            label: "Filtered by \"".concat(nameFilter, "\". Clear filter"),
                ...
                case 1:
                    ...
                    if (value === 'clear name filter') {
                        return [2 /*return*/, (0, exports.promptModel)(models)];
                    }
