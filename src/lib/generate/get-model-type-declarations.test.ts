...
describe('getModelTypeDeclarations', () => {
  ...
  it('create the named types', () => {
    const types = getModelTypeDeclarations(table);
    ...
    expect(types.findUniqueParams).toContain('export type FooBarFindUnique');
  ...
  it('deals with generated columns in the create type', () => {
    ...
    const types2 = getModelTypeDeclarations(table);
