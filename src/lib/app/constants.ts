...
export const SCHEMA_D_TS_FILENAME = 'frieda-schema.d.ts';
export const MODELS_D_FILENAME = 'models.d.ts';
export const DATABASE_FILENAME = 'database.js';
export const GENERATED_DIRECTORY = 'generated';
export const SCHEMA_VERSIONS_DIRECTORY = 'frieda-schema-versions';
