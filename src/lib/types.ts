...
export type DatabaseTableColumnInfo = {
  ...
  //    If Key is MUL, the column is the first column of a nonunique index in which multiple occurrences of a given value 
  //    are permitted within the column.
  // If more than one of the Key values applies to a given column of a table, Key displays 
  // the one with the highest priority, in the order PRI, UNI, MUL.
  // A UNIQUE index may be displayed as PRI if it cannot contain NULL values and there is no 
