...
- Whether you want to compile to javascript rather typescript.
...
├── frieda.{ts|js}   <-- generated code, don't edit
├── frieda.d.ts      <-- generated code (only exists if compileJs is true)
└── get-db.{ts|js}   <-- add this
```
